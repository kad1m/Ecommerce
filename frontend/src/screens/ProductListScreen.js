...
const ProductListScreen = () => {
  ...
  console.log('admin page kw', keyword)
  useEffect(() => {
      ...
      <ul className="space-y-2 font-medium">
        ...
        <li>
          <a href="/admin/orderlist"
            ...
            <span className="flex-1 ml-3 whitespace-nowrap">Замовлення</span>
        ...
        <li>
          <a href="/admin/userlist"
            ...
            <span className="flex-1 ml-3 whitespace-nowrap">Користувачі</span>
          </a>
        </li>
        <li>
          <a href="/admin/productlist"
            ...
            <span className="flex-1 ml-3 whitespace-nowrap">Продукти</span>
          </a>
        </li>
        <li>
          <a href="#"
            ...
            <svg
              ...
              <path stroke="currentColor" strokeLinecap="round" stroke-linejoin="round" strokeWidth="2"
