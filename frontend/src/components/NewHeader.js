...
import {listProductsCategory, listTopProducts} from "../actions/productActions";
...
export default function Example() {
  ...
  return null; // Добавьте это, если необходимо обработать остальные случаи категорий
})}
              ...
              <div className="ml-auto flex items-center">
                ...
                {userInfo ? (
                  ...
                  <a href="/register?redirect=/" className="text-sm font-medium text-gray-700 hover:text-gray-800">
                    Створити аккаунт
                  </a>
                </div>
                        )}
